...
$names = @(
    ...
    'RemainingSummaryPanel', 'RemainingNumberPanel', 'CompactPrefix',
    'RemainingValue', 'CompactSuffix', 'WindowLabel',
    'CompactProgressRow', 'ExpandedWindowLabel', 'ResetSummaryPanel',
    'ProgressTrack', 'RemainingProgressColumn',
    'UsedProgressColumn', 'DetailsPanel', 'QuotaMetricRow', 'AccountName',
    'TokenSummaryCard', 'TokenSummaryDivider',
    ...
    'FiveHourQuotaRow', 'QuotaDividerRow', 'WeeklyQuotaRow',
    'FiveHourQuotaBand', 'QuotaDivider', 'WeeklyQuotaBand',
    ...
    'Trend5HCard', 'Trend5HText', 'Trend5HCanvas', 'Trend5HArea', 'Trend5HLine',
    'Trend5HStartMarker', 'Trend5HEndMarker', 'Trend5HMetaText',
